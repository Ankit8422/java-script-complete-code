...
// 1. Mutator Method (Modify the original array):
// i) push() :
...
const names = ["shubham", "Ankit", "Avinash"];
console.log(names);
...
// console.log(newArray.indexOf("Ankit"))


// Iterable
const numbers = ["Ankit", "Shubham","Avinash"];

numbers.forEach(num => {
    console.log("Mr. " + num); // Just prints each number double
});
